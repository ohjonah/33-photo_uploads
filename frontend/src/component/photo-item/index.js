  ...
  render() {
    ...
    return (
      <div>
        ...
        {util.render(this.state.editing,
          <div>
            <PhotoForm
...
let mapDispatchToProps = (dispatch) => ({
  deletePhoto: (photo) => dispatch(photoActions.deleteUserPhotoRequest(photo)),
  updatePhoto: (photo) => dispatch(photoActions.updateUserPhotoRequest(photo)),
})
